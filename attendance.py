...
class Attendance:
    def __init__(self, root):
        ...
        dep_label_1=Label(Left_frame, text="Student Details", font=("times new roman", 25, "bold"),bg="cyan",fg="black")
        ...
        # Lables and Entry
        # Attendance ID
        attendanceID_label=Label(left_inside_frame, text="Attendance ID :", font=("times new roman", 13, "bold"),bg="darkblue",fg="white")
        ...
        # Roll No
        rollLabel=Label(left_inside_frame, text="Roll No :", bg="darkblue", font="comicsansns 11 bold",fg="white")
        rollLabel.grid(row=0,column=2,padx=10,sticky=W)

        atten_roll=ttk. Entry(left_inside_frame, width=15,textvariable=self.var_atten_roll, font="comicsansns 11 bold")
        atten_roll.grid(row=0,column=3, padx=10, pady=30, sticky=W)
        
        #Name
        namelabel=Label(left_inside_frame, text="Name :", bg="darkblue", font="comicsansns 11 bold",fg="white")
        ...
        atten_dep.grid(row=1, column=3, padx=10, pady=30, sticky=W)
